...
function Navbar() {
  return (
    ...
    <header className="d-flex flex-wrap align-items-center justify-content-center justify-content-md-between py-2 border-bottom border-dark">
      <a href="/" className="d-flex align-items-center col-md-5 mb-5 mb-md-0 text-dark text-decoration-none">
        <img src={Logo} alt="" />
      ...
      <ul className="nav col-12 col-md-auto mb-2 justify-content-center mb-md-0">
        ...
        <li><a href="#" className="nav-link px-2 menu-color">Contact Us</a></li>
      </ul>
